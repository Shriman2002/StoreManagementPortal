...
require("instore_transactions-functions.php");
...
if ($_SERVER['REQUEST_METHOD'] == 'POST')
{
    ...
    if(!empty($_POST['actionBtn']) && ($_POST['actionBtn'] == "Add Transaction")){
        addTransaction($_POST['TransactionID'], $_POST['StoreID']);
        // var_dump($_POST['Name']);
        $transactions = selectAllTransactions();
    }
    ...
    if(!empty($_POST['actionBtn']) && ($_POST['actionBtn'] == 'Confirm update')){
        updateTransaction($_POST['TransactionID'], $_POST['StoreID']);
        $transactions = selectAllTransactions();
    }
}
...
<div class="container">
  ...
  <h1>In-Store Transactions Database</h1>
  <form name="mainForm" action="instore_transactions-db.php" method="post">  
    ...
    <div class="row justify-content-center">  
        ...
        <tr>
            ...
            <td><?php echo $item['StoreID']; ?></td>       
             <td>
                <form action="instore_transactions-db.php" method="post">
